                ...
                <tr key={profile.id} className="hover:bg-black transition-colors group">
                  <td className="px-4 md:px-8 py-5">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-2xl bg-sky-400 text-black flex items-center justify-center font-black text-lg shadow-[0_0_20px_rgba(56,189,248,0.3)]">
                  ...
                  <td className="px-4 md:px-8 py-5 text-right">
                    <div className="flex items-center justify-end gap-3">
                      ...
                      {profile.status === 'blocked' && (
                        <button
                          onClick={() => updateStatus(profile.id, 'approved')}
                          className="w-10 h-10 bg-sky-400/10 text-sky-400 hover:bg-sky-400 hover:text-black rounded-xl flex items-center justify-center transition-all border border-sky-400/10"

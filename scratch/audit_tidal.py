...
EVENT_ID = '20e7a54f-4651-4175-877d-09e74a751551'
...
def main():
    ...
    with open(os.path.join(WORK_SCRATCH, 'tidal_names.txt'), 'r', encoding='utf-8') as f:
    ...
    with open(os.path.join(WORK_SCRATCH, 'apply_tidal.sql'), 'w', encoding='utf-8') as f:
